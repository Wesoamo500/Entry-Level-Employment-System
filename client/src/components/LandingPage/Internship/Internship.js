...
import {logIn} from '../../../actions/internAuth'
...
const Login = () => {
	...
	const googleSuccess = async (res) =>{
		...
		try {
            ...
            localStorage.setItem('profile',JSON.stringify({info,token}))
			navigate('/internships')
		} catch (error) {
			console.log(error)
		}
  ...
  return (
		<div>
			...
			<p className='p-added'>Don't have an account? Register <a href='/internRegister'>Here</a></p>
		</div>
  )
}
